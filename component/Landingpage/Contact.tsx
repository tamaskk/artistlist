      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 pt-10">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about our platform? Want to feature your artist profile? 
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@artistlist.com</p>
                ...
                {/* <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Supporting artists worldwide</p>
                  </div>
                </div> */}
              ...
              <div className="space-y-4">
                <div className="border-b border-gray-200 pb-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    How do I add my artist profile?
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Sign up for an account and use our dashboard to create and manage your artist profile with photos, bio, and music samples.
                  </p>
                </div>
                ...
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Basic profiles are free. Premium features and advertising options are available for enhanced visibility.
                  </p>
                </div>
                ...
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Upgrade to a premium account to access promotional tools, featured placement, and analytics to reach more fans.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Yes! Our platform connects artists for collaborations. Use the search and filter features to find potential partners.
                  </p>
                </div>
              </div>
            </div>
